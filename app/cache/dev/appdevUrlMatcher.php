...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // qiiss_get_notifications
        if (0 === strpos($pathinfo, '/get-notifications') && preg_match('#^/get\\-notifications/(?P<notyType>[^/]+)/(?P<firstResult>[^/]+)$#s', $pathinfo, $matches)) {
        ...
        if (0 === strpos($pathinfo, '/date') && preg_match('#^/date/(?P<dateid>[^/]+)$#s', $pathinfo, $matches)) {
        ...
        // qiiss_profile_post_show
        if ($pathinfo === '/wall-show') {
            return array (  '_controller' => 'Qiiss\\WallBundle\\Controller\\WallController::showPostAction',  '_route' => 'qiiss_profile_post_show',);
        }
        ...
        if (0 === strpos($pathinfo, '/profile')) {
            ...
            if (rtrim($pathinfo, '/') === '/profile') {
                ...
                return array (  '_controller' => 'Qiiss\\UserBundle\\Controller\\ProfileController::showAction',  '_route' => 'fos_user_profile_show',);
            }
            not_fos_user_profile_show:

            // fos_user_profile_edit
            if ($pathinfo === '/profile/edit') {
                return array (  '_controller' => 'Qiiss\\UserBundle\\Controller\\ProfileController::editAction',  '_route' => 'fos_user_profile_edit',);
            }
