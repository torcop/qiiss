...
/**
 * appDevDebugProjectContainer__50c1887fd8de5__
 *
 * This class has been auto-generated
 * by the Symfony Dependency Injection Component.
 */
class appDevDebugProjectContainer__50c1887fd8de5__ extends Container
{
    /**
     * Constructor.
     */
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/opt/lampp/htdocs/Qiiss/app/cache/dev_new/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/opt/lampp/htdocs/Qiiss/app/cache/dev_new/assetic/config'), true)));
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager50c1888015161_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager50c1888015161_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/opt/lampp/htdocs/Qiiss/app/cache/dev_new/jms_diextra/doctrine/EntityManager_50c1888015161.php';
        ...
        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/opt/lampp/htdocs/Qiiss/src/Qiiss/UserBundle/Entity', 1 => '/opt/lampp/htdocs/Qiiss/src/Qiiss/ProfileBundle/Entity', 2 => '/opt/lampp/htdocs/Qiiss/src/Qiiss/NotyBundle/Entity'));
        ...
        $h->setEntityNamespaces(array('FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'QiissUserBundle' => 'Qiiss\\UserBundle\\Entity', 'QiissProfileBundle' => 'Qiiss\\ProfileBundle\\Entity', 'QiissNotyBundle' => 'Qiiss\\NotyBundle\\Entity'));
        $h->setMetadataCacheImpl($b);
        $h->setQueryCacheImpl($c);
        $h->setResultCacheImpl($d);
        $h->setMetadataDriverImpl($g);
        $h->setProxyDir('/opt/lampp/htdocs/Qiiss/app/cache/dev_new/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager50c1888015161_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($i, $this);
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('mailer'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('admin@qiiss.com' => 'Admin'), 'resetting' => array('...' => '...'))));
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/opt/lampp/htdocs/Qiiss/app/cache/dev_new/jms_diextra/metadata'));
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/opt/lampp/htdocs/Qiiss/app/cache/dev_new/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/opt/lampp/htdocs/Qiiss/app/cache/dev_new/assetic/routing.yml', array('cache_dir' => '/opt/lampp/htdocs/Qiiss/app/cache/dev_new', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context'), $this->get('monolog.logger.router'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_PublicService()
    {
        ...
        $o->addHandler(new \FOS\FacebookBundle\Security\Logout\FacebookHandler($this->get('fos_facebook.api')));
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/opt/lampp/htdocs/Qiiss/app/cache/dev_new/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/opt/lampp/htdocs/Qiiss/app/cache/dev_new/sessions');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/opt/lampp/htdocs/Qiiss/app/cache/dev_new/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => 1, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/opt/lampp/htdocs/Qiiss/app/cache/dev_new/twig', 'charset' => 'UTF-8', 'paths' => array()));
     ...
     *
     * @return EntityManager50c1888015161_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/opt/lampp/htdocs/Qiiss/app/cache/dev_new/assetic/assets');
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/opt/lampp/htdocs/Qiiss/app/cache/dev_new/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/opt/lampp/htdocs/Qiiss/app/cache/dev_new');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/opt/lampp/htdocs/Qiiss/app/cache/dev_new',
            ...
            'kernel.container_class' => 'appDevDebugProjectContainer__50c1887fd8de5__',
            ...
            'debug.container.dump' => '/opt/lampp/htdocs/Qiiss/app/cache/dev_new/appDevDebugProjectContainer__50c1887fd8de5__.xml',
            ...
            'session.save_path' => '/opt/lampp/htdocs/Qiiss/app/cache/dev_new/sessions',
            ...
            'profiler.storage.dsn' => 'file:/opt/lampp/htdocs/Qiiss/app/cache/dev_new/profiler',
            ...
            'router.resource' => '/opt/lampp/htdocs/Qiiss/app/cache/dev_new/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/opt/lampp/htdocs/Qiiss/app/cache/dev_new/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => '/opt/lampp/htdocs/Qiiss/app/cache/dev_new/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/opt/lampp/htdocs/Qiiss/app/cache/dev_new/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/opt/lampp/htdocs/Qiiss/app/cache/dev_new/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/opt/lampp/htdocs/Qiiss/app/cache/dev_new/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/opt/lampp/htdocs/Qiiss/app/cache/dev_new/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/opt/lampp/htdocs/Qiiss/app/cache/dev_new/jms_diextra/doctrine/EntityManager_50c1888015161.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager50c1888015161_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/opt/lampp/htdocs/Qiiss/app/cache/dev_new/jms_security',
